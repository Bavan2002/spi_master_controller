#==============================================================================
# LAB 2 COMPLETE - SPI Master DFT Insertion with Exercises
# Run: genus -f lab2_spi_complete_auto.tcl | tee ../log/lab2_spi_execution.log
#==============================================================================

puts "=========================================================================="
puts "LAB 2: SPI MASTER DFT INSERTION - AUTOMATED EXECUTION"
puts "=========================================================================="
...
write_hdl > ../output/part1/spi_master_scan.v
...
write_hdl > ../output/part1/spi_master_dft.v
write_sdc > ../output/part1/spi_master_dft.sdc
write_scandef > ../output/part1/spi_master_dft.scandef
...
write_hdl > ../output/exercise_2chains/spi_master_dft_2chains.v
write_scandef > ../output/exercise_2chains/spi_master_dft_2chains.scandef
