#==============================================================================
# LAB 1 COMPLETE - SPI Master Synthesis with Exercises
# Run: genus -f lab1_spi_complete_auto.tcl | tee ../log/lab1_spi_execution.log
#==============================================================================

puts "=========================================================================="
puts "LAB 1: SPI MASTER SYNTHESIS - AUTOMATED EXECUTION"
puts "=========================================================================="
...
write_hdl > ../output/spi_master_initial.v
write_sdc > ../output/spi_master_initial.sdc
