#==============================================================================
# LAB 3 COMPLETE - SPI Master Place & Route with Exercises
# Run in Innovus: source lab3_spi_complete_auto.tcl
#==============================================================================

puts "=========================================================================="
puts "LAB 3: SPI MASTER PLACE & ROUTE - AUTOMATED EXECUTION"
puts "=========================================================================="
...
set init_verilog ../input/spi_master_dft.v
...
floorPlan -site CoreSite -r 1.0 -coreUtilization 0.4 -coreSpacing 5 5 5 5
...
addStripe -nets {VDD GND} -layer Metal7 -direction horizontal \
    -width 1.0 -spacing 0.8 -number_of_sets 3
addStripe -nets {VDD GND} -layer Metal8 -direction vertical \
    -width 1.0 -spacing 0.8 -number_of_sets 3

puts ">>> Placing IO pins..."
editPin -side Top -spreadType center -spacing 5 -pin {clk reset start cpol cpha SE}
editPin -side Left -spreadType center -spacing 5 -pin {tx_data* clk_div*}
editPin -side Bottom -spreadType center -spacing 5 -pin {miso scan_in}
editPin -side Right -spreadType center -spacing 5 -pin {rx_data* rx_valid busy sclk mosi ss_n scan_out}
...
streamOut ../output/part1_with_preopt/spi_master.gds \
    -mapFile ../input/streamOut.map -libName spilib -mode ALL
...
restoreDesign ../output/part1_prePlacement.enc.dat spi_master
placeDesign
...
streamOut ../output/exercise1_without_preopt/spi_master.gds \
    -mapFile ../input/streamOut.map -libName spilib -mode ALL
...
floorPlan -site CoreSite -r 1.0 -coreUtilization 0.4 \
...
streamOut ../output/exercise3_with_io/spi_master.gds \
    -mapFile ../input/streamOut.map -libName spilib -mode ALL
